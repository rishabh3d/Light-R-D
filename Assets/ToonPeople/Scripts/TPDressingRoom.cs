    ...
    public class TPDressingRoom : MonoBehaviour
    {
        ...
        public void SetTie(int index)
        {
            if (gender == 0)
            {
                ...
                {
                    int temptie = Character.GetComponent<TPMalePrefabMaker>().CheckBodyPart(2);
                    if (index == 2)
                    {
                        if (temptie == 2)
                            Character.GetComponent<TPMalePrefabMaker>().Settie(3);
                        else if (temptie == 3)
                            Character.GetComponent<TPMalePrefabMaker>().Settie(0);
                        else if (temptie == 0)
                            Character.GetComponent<TPMalePrefabMaker>().Settie(2);
                        else if (temptie == 1)
                            Character.GetComponent<TPMalePrefabMaker>().Settie(1);
                    }
                    else
                        if (index == 1)
                        Character.GetComponent<TPMalePrefabMaker>().Settie(1);

                    temptie = Character.GetComponent<TPMalePrefabMaker>().CheckBodyPart(2);
                    if (temptie > 0)
            ...
            else
            {
                ...
                {
                    int temptie = Character.GetComponent<TPFemalePrefabMaker>().CheckBodyPart(2);
                    if (index == 2)
                    {
                        if (temptie == 2)
                            Character.GetComponent<TPFemalePrefabMaker>().Settie(3);
                        else if (temptie == 3)
                            Character.GetComponent<TPFemalePrefabMaker>().Settie(0);
                        else if (temptie == 0)
                            Character.GetComponent<TPFemalePrefabMaker>().Settie(2);
                        else if (temptie == 1)
                            Character.GetComponent<TPFemalePrefabMaker>().Settie(1);
                    }
                    else
                        if (index == 1)
                        Character.GetComponent<TPFemalePrefabMaker>().Settie(1);

                    temptie = Character.GetComponent<TPFemalePrefabMaker>().CheckBodyPart(2);
                    if (temptie > 0)
        ...
        {
            if (gender == 0)
                Character.GetComponent<TPMalePrefabMaker>().Nude();
            else
                Character.GetComponent<TPFemalePrefabMaker>().Nude();
        }
