...
{
    [CustomEditor(typeof(TPFemalePrefabMaker_VR))]

    public class EditorTPFemalePrefabMaker_VR : Editor
    {
        public override void OnInspectorGUI()
        {
            EditorGUI.BeginChangeCheck();
            TPFemalePrefabMaker_VR myPrefabMaker = (TPFemalePrefabMaker_VR)target;
