...

    {
...

        {
            ...
            else
            {
                ...
                jacket = 0;
                for (int forAUX = 0; forAUX < jacketnames.Length; forAUX++)
                    if (GOjackets[forAUX].activeSelf) jacket = forAUX + 1;
                tie = 0;
                for (int forAUX = 0; forAUX < 3; forAUX++)                
                    if (GOties[forAUX].activeSelf) tie = forAUX + 1;                
        ...
        {
            if (chest < 3) ChangeMaterial(GOchest[1], MATDress, todo, 0);
            if (chest < 3) ChangeMaterial(GOchest[2], MATDress, todo, 0);
        ...
        public void Nextlegscolor(int todo)
        {
            ...
            ChangeMaterial(GOlegs[4], MATDress, todo, 0);
        }
        ...
        public void Sets(int setN)
        {
            ...
            if (setN == 0) newset = new int[18] { 0, 25, 1, 25, 25, 0, 8, 0, 9, 12, 1, 6, 0, 0, 3, 12, 2, 8 };
            if (setN == 1) newset = new int[18] { 8, 25, 8, 25, 25, 0, 8, 0, 9, 14, 1, 6, 0, 0, 1, 14, 2, 9 };
            if (setN == 2) newset = new int[18] { 8, 25, 3, 25, 25, 0, 8, 0, 2, 13, 1, 6, 0, 0, 3, 13, 2, 3 };
            if (setN == 3) newset = new int[18] { 4, 25, 0, 25, 25, 0, 8, 0, 8, 1, 1, 6, 0, 0, 1, 6, 2, 4 };
            if (setN == 4) newset = new int[18] { 8, 25,10, 25, 25, 1, 3, 0, 9, 4, 2, 2, 0, 0, 3, 0, 2, 1 };

            if (setN == 5) newset = new int[18] { 4, 25, 0, 25, 25, 0, 3, 0, 5, 10, 3, 7, 0, 0, 4, 7, 1, 7 };
            if (setN == 6) newset = new int[18] { 1, 25, 0, 25, 25, 0, 9, 0, 2, 4, 0, 0, 0, 0, 2, 8, 1, 3 };
            if (setN == 7) newset = new int[18] { 3, 25, 0, 25, 25, 1, 0, 0, 5, 6, 0, 0, 2, 2, 2, 3, 2, 6 };
            if (setN == 8) newset = new int[18] { 2, 25, 3, 25, 25, 0, 3, 0, 6, 0, 3, 9, 0, 0, 1, 5, 1, 1 };
            if (setN == 9) newset = new int[18] { 6, 25, 1, 25, 25, 0, 2, 0, 1, 13, 3, 9, 0, 0, 3, 11, 3, 9 };

            if (setN == 10) newset = new int[18] { 0, 25, 2, 25, 25, 0, 8, 0, 3, 6, 2, 3, 1, 1, 2, 13, 1, 10 };
            if (setN == 11) newset = new int[18] { 1, 25, 1, 25, 25, 0, 3, 0, 3, 9, 2, 5, 1, 0, 4, 10, 3, 10 };
            if (setN == 12) newset = new int[18] { 2, 25, 2, 25, 25, 0, 8, 0, 7, 13, 2, 3, 1, 3, 1, 7, 1, 0 };
            if (setN == 13) newset = new int[18] { 3, 25, 2, 25, 25, 0, 8, 0, 2, 11, 2, 3, 1, 6, 2, 2, 1, 1 };
            if (setN == 14) newset = new int[18] { 4, 25, 2, 25, 25, 0, 3, 0, 1, 7, 1, 1, 1, 7, 2, 7, 3, 9 };
        ...
        private void SetSet(int[] CharSet)
        {
            ...
            if (CharSet[1] > 10)
                ChangeMaterial(GOhair[hair], MatALLHairs[hair], 2, 0);
            else
            ...
            //chest
            Object[][] MatALLChests = new Object[10][] { MATDress, MATDress, MATDress, MATShirtA, MATShirtA, MATShirtB, MATShirtB, MATTshirt, MATTshirt, MATTshirt };
            chest = CharSet[8];
            GOchest[chest].SetActive(true);
            ...
            //legs
            Object[][] MatALLlegs = new Object[5][] { MATLegs, MATLegs, MATLegs, MATLegs, MATDress };
            legs = CharSet[14];
            GOlegs[legs].SetActive(true);
            ChangeMaterial(GOlegs[legs], MatALLlegs[legs], 6, CharSet[15]);

            //feet
            Object[][] MatALLfeet = new Object[4][] { MATFeetA, MATFeetA, MATFeetB, MATFeetC };
            feet = CharSet[16];
            GOfeet[feet].SetActive(true);
        ...
        void ChangeMaterial(GameObject GO, Object[] MAT, int todo, int newindex)
        {
            ...
            if (found)
            {
                ...
                else if (todo == 1) //decrease
                {
                    MATindex--;
                    if (MATindex < 0) MATindex = MAT.Length - 1;
                }
                else if (todo == 2) //random value
                {
                    MATindex = Random.Range(0, MAT.Length);
                }
                else if (todo == 3) //reset value
                {
                    MATindex = 0;
                }
                else if (todo == 4) //penultimate
                {
                    MATindex = MAT.Length - 2;
                }
                else if (todo == 5) //last one
                {
        ...
        void ChangeMaterials(Object[] MAT, int todo)
        {
            ...
            ChangeMaterial(GOjackets[0], MAT, todo, 0);
            ChangeMaterial(GOjackets[1], MAT, todo, 0);
